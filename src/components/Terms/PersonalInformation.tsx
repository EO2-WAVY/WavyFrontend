...
export const PersonalInformation = () => {
    return (
        <>
            {"< wavy >"}('https://www.wavy.dance'이하 'wavy')은(는) 「개인정보
            ...
            <br />
            <br />
            {"< wavy >"}('https://www.wavy.dance'이하 'wavy')은(는) 다음의
            ...
            <br />
            <br />① {"< wavy >"}은(는) 법령에 따른 개인정보 보유·이용기간 또는
            ...
            로그인ID, 서비스 이용 기록, 접속 로그, 접속 IP 정보
            <br />
            제공받는 자의 보유.이용기간: 3년
            <br />
            <br />
            제4조(개인정보처리 위탁)
            <br />
            <br />① {"< wavy >"}은(는) 원활한 개인정보 업무처리를 위하여 다음과
            ...
            <br />
            <br />
            ① 정보주체는 wavy에 대해 언제든지 개인정보 열람·정정·삭제·처리정지
            요구 등의 권리를 행사할 수 있습니다.
            <br />
            ② 제1항에 따른 권리 행사는wavy에 대해 「개인정보 보호법」 시행령
            제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수
            있으며 wavy은(는) 이에 대해 지체 없이 조치하겠습니다.
            <br />
            ...
            <br />
            ⑥ wavy은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구,
            ...
            <br />
            <br />① {"< wavy >"}은(는) 다음의 개인정보 항목을 처리하고 있습니다.
            <br />1{"< 홈페이지 회원가입 및 관리 >"}
            <br />
            필수항목 : 이메일, 휴대전화번호, 로그인ID, 서비스 이용 기록, 접속
            로그, 쿠키, 접속 IP 정보
            <br />
            선택항목 : 자택전화번호, 이름, 법정대리인 이름, 법정대리인 자택
            전화번호, 법정대리인 자택 주소, 법정대리인 휴대전화번호
            <br />
            <br />
            제7조(개인정보의 파기)
            <br />
            <br />① {"< wavy >"} 은(는) 개인정보 보유기간의 경과, 처리목적 달성
            ...
            1. 파기절차
            <br />
            {"< wavy >"} 은(는) 파기 사유가 발생한 개인정보를 선정하고,{" "}
            {"< wavy >"} 의 개인정보 보호책임자의 승인을 받아 개인정보를
            파기합니다.
            <br />
            2. 파기방법
            <br />
            ...
            제8조(개인정보의 안전성 확보 조치)
            <br />
            {"< wavy >"}은(는) 개인정보의 안전성 확보를 위해 다음과 같은 조치를
            취하고 있습니다.
            <br />
            1. 정기적인 자체 감사 실시
            <br />
            ...
            2. 해킹 등에 대비한 기술적 대책
            <br />
            {"<wavy>"}('wavy')은 해킹이나 컴퓨터 바이러스 등에 의한 개인정보
            ...
            <br />
            <br />
            wavy 은(는) 정보주체의 이용정보를 저장하고 수시로 불러오는
            ‘쿠키(cookie)’를 사용하지 않습니다.
            <br />
            제10조 (개인정보 보호책임자)
            <br />
            ① wavy 은(는) 개인정보 처리에 관한 업무를 총괄해서 책임지고,
            ...
            연락처 :, ,
            <br />
            ② 정보주체께서는 wavy 의 서비스(또는 사업)을 이용하시면서 발생한
            모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을
            개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. wavy 은(는)
            ...
            <br />
            <br />
            {"< wavy >"} 은(는) 다음과 같은 목적으로 가명정보를 처리하고
            있습니다.
            <br />
            ▶ 가명정보의 처리 목적
            <br />
            ...
            <br />
            <br />
            정보주체는 ｢개인정보 보호법｣ 제39조의11에 따라 지정된 {"< wavy >"}의
            국내대리인에게 개인정보 관련 고충처리 등의 업무를 위하여 연락을 취할
            수 있습니다. {"< wavy >"}은(는) 정보주체의 개인정보 관련 고충처리 등
            개인정보 보호책임자의 업무 등을 신속하게 처리할 수 있도록
            노력하겠습니다.
            <br />▶ {"< wavy >"} 은(는) ｢개인정보 보호법｣ 제39조의11에 따라
            국내대리인을 지정하였습니다.
            <br />
            ...
            아래의 부서에 할 수 있습니다.
            <br />
            {"< wavy >"}은(는) 정보주체의 개인정보 열람청구가 신속하게
            처리되도록 노력하겠습니다.
            <br />
            ▶ 개인정보 열람청구 접수·처리 부서
            <br />
